...
<title>Admin - Search Teacher</title>
	...
	<?php include('../common/admin-sidebar.php') ?>  
		<main role="main" class="col-xl-10 col-lg-9 col-md-8 ml-sm-auto px-md-4 mb-2 w-100 page-content-index">
            ...
            <div class="row">
                <div class="col-md-6">
                <form action="fetch-teach.php" method="post">
                <input type="text" name="teacher_id" id="regno" class="form form-control" placeholder="Enter Teacher ID:">

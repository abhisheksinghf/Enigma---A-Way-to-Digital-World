...
// *****************************************Images upload code end here********************************************************** 
 		...
 		// }
 		$query2="insert into login(user_id,Password,Role,account)values('$register_no','$password','$role','Activate')";
...
// *****************************************Images upload code end here********************************************************** 
 		...
 		$query="UPDATE `student_information` SET `register_no`='$register_no',`first_name`='$first_name',`middle_name`='$middle_name',`last_name`='$last_name',`email`='$email',`mobile_no`='$mobile_no',`mobile_no_2`='$mobile_no_2',`course`='$course_code',`applicant_status`='$applicant_status',`application_status`='$application_status',`dob`='$dob',`native_city`='$city',`pincode`='$pincode',`caste`='$caste',`subcaste`='$subcaste',`gender`='$gender',`date_of_submission`='$dos',`nationality`='$nationality',`sslc_percentage`='$sslc_per',`home_address`='$home_address',`place_of_birth`='$place_of_birth',`mother_tongue`='$mother_tongue',`sslc_complition_date`='$sslc_complition_date',`sslc_attempt`='$sslc_attempt',`profile_image`='$profile_image',`matric_certificate`='$matric_certificate' WHERE `register_no`='$register_no'";
 		$run=mysqli_query($con, $query);
 		if ($run) {
	...
	<body>
		...
		<main role="main" class="col-xl-10 col-lg-9 col-md-8 ml-sm-auto px-md-4 w-100">
			<div class="sub-main">
				...
				<a href="fetch-student-info.php" class="mt-4">Click Here to get Detailed Information about a Student</a>
				...
				<div class="col-md-2 pt-3 w-100">
					...
					<div class="modal fade bd-example-modal-lg-2" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
					   <div class="modal-dialog modal-lg">
						    <div class="modal-content">
							    <div class="modal-header bg-info-header text-white">
							        <h4 class="modal-title text-center">Update Student Information</h4>
						        </div>
							    <div class="modal-body">
							        <form action="student.php" method="POST" enctype="multipart/form-data">
										<div class="row mt-3">
										...
										<div class="row">
											...
											<div class="col-md-4">
												<div class="form-group">
												    <label for="exampleInputPassword1">Date of Updation:</label>
												    <input type="text" id="currentdate" value="27-08-2022" readonly name="dos" class="form-control">
											    </div>
											</div>
											<div class="col-md-4">
												  <div class="form-group">

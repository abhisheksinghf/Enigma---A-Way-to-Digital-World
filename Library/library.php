...
.servive-block-purple {
  background: radial-gradient(circle, rgb(2, 0, 36) 0%, rgb(55, 6, 72) 35%, rgb(200, 90, 239) 100%);
}
.servive-block-aqua {
  background: #27d7e7;
}
    ...
    <div class="row margin-bottom-10">
        <div class="col-sm-6">
            <div class="servive-block servive-block-purple">
                <i class="icon-2x color-light fa fa-users"></i>
                <h2 class="heading-md">Total Books</h2>
                <?php
		...
		<div class="col-sm-6">
			<div class="servive-block servive-block-purple">
				<i class="icon-2x color-light fa fa-user"></i>
                <h2 class="heading-md">Total Magazine</h2>
                <?php
		...
		<div class="col-sm-6">
			<div class="servive-block servive-block-purple">
                ...
                <h2 class="heading-md">Total Newspaper</h2>
                <?php
                  $sql = "select * from news_paper";
                  $run = mysqli_query($con,$sql);
                  $count = mysqli_num_rows($run);
                  echo "<h1 class='text-white fs-1'>$count</h1>";
                ?>
		...
		<div class="col-sm-6">
			<div class="servive-block servive-block-purple">
                ...
                <h2 class="heading-md">Total Books Issued</h2>
                <?php
